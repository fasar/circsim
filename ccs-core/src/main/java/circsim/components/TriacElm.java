package circsim.components;// stub implementation of circsim.TriacElm, based on circsim.SCRElm
// FIXME need to add circsim.TriacElm to srclist
// FIXME need to uncomment circsim.TriacElm line from circsim.CirSim.java

import circsim.EditInfo;
import circsim.logic.Diode;
