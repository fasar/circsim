package circsim.components;// stub circsim.PhotoResistorElm based on circsim.SparkGapElm
// FIXME need to uncomment circsim.PhotoResistorElm line from circsim.CirSim.java
// FIXME need to add circsim.PhotoResistorElm.java to srclist
...
public class PhotoResistorElm extends CircuitElm {
    ...
    public void draw(Graphics g) {
        ...
        draw2Leads(g);
        // FIXME need to draw properly, see circsim.ResistorElm.java
