package circsim;// circsim.CirSim.java (c) 2010 by Paul Falstad

// For information about the theory behind this, see Electronic circsim.Circuit & System Simulation Methods by Pillage

import circsim.components.*;
...
public class CirSim extends Frame
    ...
    public MenuItem exportItem, exportLinkItem, importItem, exitItem, undoItem, redoItem,
    ...
    public CirSim(Circuit a) {
        super("circsim.Circuit Simulator v1.6i");
        applet = a;
        useFrame = false;
    }

    public String getAppletInfo() {
        return "circsim.Circuit by Paul Falstad";
    }
    ...
    public void init() {
        ...
        mainMenu.add(getClassCheckItem("Add Wire", "circsim.WireElm"));
        mainMenu.add(getClassCheckItem("Add Resistor", "circsim.ResistorElm"));

        Menu passMenu = new Menu("Passive Components");
        mainMenu.add(passMenu);
        passMenu.add(getClassCheckItem("Add Capacitor", "circsim.components.CapacitorElm"));
        passMenu.add(getClassCheckItem("Add circsim.Inductor", "circsim.InductorElm"));
        passMenu.add(getClassCheckItem("Add Switch", "circsim.SwitchElm"));
        passMenu.add(getClassCheckItem("Add Push Switch", "circsim.PushSwitchElm"));
        passMenu.add(getClassCheckItem("Add SPDT Switch", "circsim.Switch2Elm"));
        passMenu.add(getClassCheckItem("Add Potentiometer", "circsim.PotElm"));
        passMenu.add(getClassCheckItem("Add Transformer", "circsim.TransformerElm"));
        passMenu.add(getClassCheckItem("Add Tapped Transformer",
                "circsim.TappedTransformerElm"));
        passMenu.add(getClassCheckItem("Add Transmission Line", "circsim.TransLineElm"));
        passMenu.add(getClassCheckItem("Add Relay", "circsim.RelayElm"));
        passMenu.add(getClassCheckItem("Add Memristor", "circsim.MemristorElm"));
        passMenu.add(getClassCheckItem("Add Spark Gap", "circsim.SparkGapElm"));

        Menu inputMenu = new Menu("Inputs/Outputs");
        mainMenu.add(inputMenu);
        inputMenu.add(getClassCheckItem("Add Ground", "circsim.GroundElm"));
        inputMenu.add(getClassCheckItem("Add Voltage Source (2-terminal)", "circsim.DCVoltageElm"));
        inputMenu.add(getClassCheckItem("Add A/C Source (2-terminal)", "circsim.ACVoltageElm"));
        inputMenu.add(getClassCheckItem("Add Voltage Source (1-terminal)", "circsim.RailElm"));
        inputMenu.add(getClassCheckItem("Add A/C Source (1-terminal)", "circsim.ACRailElm"));
        inputMenu.add(getClassCheckItem("Add Square Wave (1-terminal)", "circsim.SquareRailElm"));
        inputMenu.add(getClassCheckItem("Add Analog Output", "circsim.OutputElm"));
        inputMenu.add(getClassCheckItem("Add Logic Input", "circsim.LogicInputElm"));
        inputMenu.add(getClassCheckItem("Add Logic Output", "circsim.LogicOutputElm"));
        inputMenu.add(getClassCheckItem("Add Clock", "circsim.ClockElm"));
        inputMenu.add(getClassCheckItem("Add A/C Sweep", "circsim.SweepElm"));
        inputMenu.add(getClassCheckItem("Add Var. Voltage", "circsim.VarRailElm"));
        inputMenu.add(getClassCheckItem("Add Antenna", "circsim.AntennaElm"));
        inputMenu.add(getClassCheckItem("Add AM source", "circsim.AMElm"));
        inputMenu.add(getClassCheckItem("Add FM source", "circsim.FMElm"));
        inputMenu.add(getClassCheckItem("Add Current Source", "circsim.CurrentElm"));
        inputMenu.add(getClassCheckItem("Add LED", "circsim.LEDElm"));
        inputMenu.add(getClassCheckItem("Add Lamp (beta)", "circsim.LampElm"));
        inputMenu.add(getClassCheckItem("Add LED Matrix", "circsim.LEDMatrixElm"));
        ...
        activeMenu.add(getClassCheckItem("Add circsim.Diode", "circsim.DiodeElm"));
        activeMenu.add(getClassCheckItem("Add Zener circsim.Diode", "circsim.ZenerElm"));
        activeMenu.add(getClassCheckItem("Add Transistor (bipolar, NPN)",
                "circsim.NTransistorElm"));
        activeMenu.add(getClassCheckItem("Add Transistor (bipolar, PNP)",
                "circsim.PTransistorElm"));
        activeMenu.add(getClassCheckItem("Add Op Amp (- on top)", "circsim.OpAmpElm"));
        activeMenu.add(getClassCheckItem("Add Op Amp (+ on top)",
                "circsim.OpAmpSwapElm"));
        ...
        activeMenu.add(getClassCheckItem("Add JFET (p-channel)",
                "circsim.components.PJfetElm"));
        activeMenu.add(getClassCheckItem("Add Analog Switch (SPST)", "circsim.AnalogSwitchElm"));
        activeMenu.add(getClassCheckItem("Add Analog Switch (SPDT)", "circsim.AnalogSwitch2Elm"));
        activeMenu.add(getClassCheckItem("Add Tristate buffer", "circsim.TriStateElm"));
        activeMenu.add(getClassCheckItem("Add Schmitt Trigger", "circsim.SchmittElm"));
        activeMenu.add(getClassCheckItem("Add Schmitt Trigger (Inverting)", "circsim.InvertingSchmittElm"));
        activeMenu.add(getClassCheckItem("Add SCR", "circsim.SCRElm"));
        //activeMenu.add(getClassCheckItem("Add Varactor/Varicap", "VaractorElm"));
        activeMenu.add(getClassCheckItem("Add Tunnel circsim.Diode", "circsim.TunnelDiodeElm"));
        activeMenu.add(getClassCheckItem("Add Triode", "circsim.TriodeElm"));
        //activeMenu.add(getClassCheckItem("Add Diac", "circsim.DiacElm"));
        //activeMenu.add(getClassCheckItem("Add Triac", "circsim.TriacElm"));
        //activeMenu.add(getClassCheckItem("Add Photoresistor", "circsim.PhotoResistorElm"));
        //activeMenu.add(getClassCheckItem("Add Thermistor", "circsim.ThermistorElm"));
        activeMenu.add(getClassCheckItem("Add CCII+", "circsim.CC2Elm"));
        activeMenu.add(getClassCheckItem("Add CCII-", "circsim.CC2NegElm"));

        Menu gateMenu = new Menu("Logic Gates");
        mainMenu.add(gateMenu);
        gateMenu.add(getClassCheckItem("Add Inverter", "circsim.InverterElm"));
        gateMenu.add(getClassCheckItem("Add NAND Gate", "circsim.NandGateElm"));
        gateMenu.add(getClassCheckItem("Add NOR Gate", "circsim.NorGateElm"));
        gateMenu.add(getClassCheckItem("Add AND Gate", "circsim.AndGateElm"));
        gateMenu.add(getClassCheckItem("Add OR Gate", "circsim.OrGateElm"));
        gateMenu.add(getClassCheckItem("Add XOR Gate", "circsim.XorGateElm"));

        Menu chipMenu = new Menu("Chips");
        mainMenu.add(chipMenu);
        chipMenu.add(getClassCheckItem("Add D Flip-Flop", "circsim.DFlipFlopElm"));
        chipMenu.add(getClassCheckItem("Add JK Flip-Flop", "circsim.JKFlipFlopElm"));
        chipMenu.add(getClassCheckItem("Add T Flip-Flop", "circsim.TFlipFlopElm"));
        chipMenu.add(getClassCheckItem("Add 7 Segment LED", "circsim.SevenSegElm"));
        chipMenu.add(getClassCheckItem("Add 7 Segment Decoder", "circsim.SevenSegDecoderElm"));
        chipMenu.add(getClassCheckItem("Add Multiplexer", "circsim.MultiplexerElm"));
        chipMenu.add(getClassCheckItem("Add Demultiplexer", "circsim.DeMultiplexerElm"));
        chipMenu.add(getClassCheckItem("Add SIPO shift register", "circsim.SipoShiftElm"));
        chipMenu.add(getClassCheckItem("Add PISO shift register", "circsim.PisoShiftElm"));
        chipMenu.add(getClassCheckItem("Add Phase Comparator", "circsim.PhaseCompElm"));
        chipMenu.add(getClassCheckItem("Add Counter", "circsim.CounterElm"));
        chipMenu.add(getClassCheckItem("Add Decade Counter", "circsim.DecadeElm"));
        chipMenu.add(getClassCheckItem("Add 555 Timer", "circsim.TimerElm"));
        chipMenu.add(getClassCheckItem("Add DAC", "circsim.DACElm"));
        chipMenu.add(getClassCheckItem("Add ADC", "circsim.ADCElm"));
        chipMenu.add(getClassCheckItem("Add Latch", "circsim.LatchElm"));
        //chipMenu.add(getClassCheckItem("Add Static RAM", "circsim.SRAMElm"));
        chipMenu.add(getClassCheckItem("Add Sequence generator", "circsim.SeqGenElm"));
        chipMenu.add(getClassCheckItem("Add VCO", "circsim.VCOElm"));
        chipMenu.add(getClassCheckItem("Add Full Adder", "circsim.FullAdderElm"));
        chipMenu.add(getClassCheckItem("Add Half Adder", "circsim.HalfAdderElm"));
        chipMenu.add(getClassCheckItem("Add Monostable", "circsim.MonostableElm"));

        Menu otherMenu = new Menu("Other");
        mainMenu.add(otherMenu);
        otherMenu.add(getClassCheckItem("Add Text", "circsim.TextElm"));
        otherMenu.add(getClassCheckItem("Add Box", "circsim.BoxElm"));
        otherMenu.add(getClassCheckItem("Add circsim.Scope Probe", "circsim.ProbeElm"));
        ...
        Label l;
        l = new Label("Current circsim.Circuit:");
        l.setFont(f);
...
//	setupList = new Vector();
        ...
        elmMenu.add(elmScopeMenuItem = getMenuItem("View in circsim.Scope"));
...
//	    impDialog = new circsim.ImportExportClipboardDialog(this,
//		circsim.ImportExportDialog.Action.IMPORT);
        pushUndo();
        impDialog.execute();
    }
...
//	    expDialog = new circsim.ImportExportClipboardDialog(this,
//		 circsim.ImportExportDialog.Action.EXPORT);
        }
