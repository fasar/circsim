package circsim.components;// stub circsim.ThermistorElm based on circsim.SparkGapElm
// FIXME need to uncomment circsim.ThermistorElm line from circsim.CirSim.java
// FIXME need to add circsim.ThermistorElm.java to srclist
